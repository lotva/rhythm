...
If the outer space is too small, elements invade each other’s personal space and the layout looks jammed. Increase the outer, and each element gains independence.
...
Rhythm formalizes this pattern by using the visual line gap as its primary module. This standardizes layout decisions and prevents common typesetting errors, such as spacing overlaps.
...
<pre
	class="p-1g -m-0.5g mt-0.5g mbs-2gr gap-x-1g min-w-12g max-w-40g size-4g -top-0.5gr"
></pre>
```
